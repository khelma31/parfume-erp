                            ...
                            <table class="table table-striped" id="table1">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Offenburg</td>
                                        <td>
                                            <a type="button" class="btn btn-outline-secondary btn-sm me-1" href='overview-bom.php'>
                                                <i class="bi bi-search bi-middle"></i>
                                            </a>
                                            <a type="button" class="btn btn-outline-success btn-sm me-1" href='edit-bom.php'>
